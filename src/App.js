...
class App extends React.Component {
  ...
  handleClick = (e) => {
    document.querySelectorAll('.tabs > button').forEach((tab) => {
      [tab.className] = tab.className.split(' ') // eslint-disable-line no-param-reassign
    })
    this.setState({ display: e.target.className })
      ...
      <div className='App'>
        ...
        <main className='main'>
          ...
          <div id='projects'>
            <h3>Projects</h3>
            <div className='tabs'>
              <button type='button' className='app active' onClick={this.handleClick}>Apps</button>
              <button type='button' className='website' onClick={this.handleClick}>Websites</button>
            </div>
