export default [
  {
    ...
    bullets: [
      "Modernized IBM Verify’s front-end stack (TypeScript 5, React 18, Webpack 5), strengthening type safety & cutting bundle size by 91.7%, build times by 63%, and deployment times by 36%",
      ...
      "Led ESLint migration and added automated checks, raising product’s code quality standards",
      "Designed & implemented robust, reusable React components adopted across Verify teams",
  ...
  },
  {
    ...
    bullets: [
      "Built TypeScript React FIDO2 password-less authentication POC for IBM Verify IAM",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Redesigned mapping feature of flagship React product with a focus on modern UI/UX",
    ],
  },
  {
